...
exports.IMAGE_STYLE_PROMPT = exports.PRESET_PROMPTS = exports.PLATFORM_PROMPTS = exports.BASE_MARKETER_SYSTEM_PROMPT = void 0;
exports.buildContentPrompt = buildContentPrompt;
exports.buildImagePrompt = buildImagePrompt;
exports.BASE_MARKETER_SYSTEM_PROMPT = `You are an expert social media strategist and conversion copywriter for an enterprise brand.
...
exports.IMAGE_STYLE_PROMPT = `Create a scroll-stopping social media image.
...
function buildContentPrompt(args) {
    ...
    const brandBlock = brand
        ? [
            ...
            ((_a = brand.bannedTopics) === null || _a === void 0 ? void 0 : _a.length)
                ? `- NEVER mention: ${brand.bannedTopics.join(", ")}`
                : "",
            ((_c = (_b = brand.hashtagSets) === null || _b === void 0 ? void 0 : _b.default) === null || _c === void 0 ? void 0 : _c.length)
                ? `- Preferred hashtags to draw from: ${brand.hashtagSets.default.join(" ")}`
                : "",
            ((_d = brand.sampleCaptions) === null || _d === void 0 ? void 0 : _d.length)
    ...
    const systemInstruction = [
        exports.BASE_MARKETER_SYSTEM_PROMPT,
        "",
        exports.PLATFORM_PROMPTS[platform],
        "",
        (_e = exports.PRESET_PROMPTS[automation.preset]) !== null && _e !== void 0 ? _e : exports.PRESET_PROMPTS.custom,
    ].join("\n");
    const prompt = [
        brandBlock,
        "",
...
function buildImagePrompt(args) {
    ...
    return [
        exports.IMAGE_STYLE_PROMPT,
        "",
        brand
            ? `Brand: ${brand.name}, industry: ${brand.industry}.${((_a = brand.colors) === null || _a === void 0 ? void 0 : _a.primary) ? ` Brand palette hint: ${brand.colors.primary}${brand.colors.accent ? `, ${brand.colors.accent}` : ""}.` : ""}`
            : "",
        "",
...
//# sourceMappingURL=marketingPrompts.js.map
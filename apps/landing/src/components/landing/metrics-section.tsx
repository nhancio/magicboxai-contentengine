...
const metrics = [
  { value: 128394, suffix: "", prefix: "", label: "Posts published for teams" },
  { value: 98, suffix: "%", prefix: "", label: "Rated on-brand on first pass" },
  { value: 9, suffix: "s", prefix: "~", label: "To generate a post + image" },
  { value: 3, suffix: "", prefix: "", label: "Channels from a single prompt" },
];

...
export default function AvatarCreator() {
 ...
 const [creationStep, setCreationStep] = useState<"idle" |"uploading" |"analyzing" |"generating-video" |"saving" |"done"
 >("idle");
 ...
 analyzing:"AI is analyzing your photos...","generating-video":"Generating avatar video with AI...",
 ...
 <Badge
 variant="secondary"
 className={cn("border-0 px-2.5 py-0.5",
 ...
 disabled={isCreating}
 className={cn("w-full h-full rounded-xl border-2 border-dashed flex flex-col items-center justify-center gap-1 transition-colors cursor-pointer","border-border/[0.08] hover:border-brand/40 hover:bg-brand/[0.03]",
 ...
 className="w-full h-12 bg-brand hover: hover: text-foreground gap-2 text-base rounded-xl"
 >
 {isCreating ? (
 <>
